...
export function groupSClassShots(shots, maxDurationSec = SCLASS_MAX_DURATION_SEC) {
...
export function validateSClassReferences(imageCount, videoCount) {
...
export function compileSClassPrompt(group, shots, opts = {}) {
