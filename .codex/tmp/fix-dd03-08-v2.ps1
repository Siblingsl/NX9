...
$oldMarker = '                  {shot.director3dGuide?.captureUrl ? <i className="dd2-frame__3d" title="有 3D 参考" /> : null}'
$newMarker = '                  {shot.director3dGuide?.captureUrl ? <i className="dd2-frame__3d" title="有 3D 参考" /> : shot.director3dGuide?.captureUrlPendingRepair ? <i className="dd2-frame__3d is-repair" title="3D 待修复" /> : null}'
Replace-One $p3 $oldMarker $newMarker 'filmstrip pending repair marker'
