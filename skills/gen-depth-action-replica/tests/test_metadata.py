#!/usr/bin/env python3
"""Metadata + layout tests for gen-depth-action-replica."""
import json
...
def test_metadata_name_matches_dir():
    ...
    assert meta.get("nx9", {}).get("playbookId") == "depth-action-replica"
...
def test_layout_complete():
    for rel in [
        ...
        "templates/output-schema.md", "templates/prompt-pack.md",
...
if __name__ == "__main__":
    ...
    print("PASS gen-depth-action-replica")
