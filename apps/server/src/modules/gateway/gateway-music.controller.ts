...
export class GatewayMusicController {
  ...
  @Post()
  submit(@Body() body: { prompt: string; durationSec?: number; provider?: string; apiKey?: string; baseUrl?: string }) {
    return this.music.submit(body.prompt, body.durationSec ?? 30, body.provider, body.apiKey, body.baseUrl);
  }
